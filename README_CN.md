...
[![GitHub stars](https://img.shields.io/github/stars/onchainyaotoshi/claude-code-switch.svg)](https://github.com/onchainyaotoshi/claude-code-switch/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/onchainyaotoshi/claude-code-switch.svg)](https://github.com/onchainyaotoshi/claude-code-switch/issues)
...
```bash
# 1. 安装
curl -fsSL https://raw.githubusercontent.com/onchainyaotoshi/claude-code-switch/main/quick-install.sh | bash
...
### 本地安装
```bash
git clone https://github.com/onchainyaotoshi/claude-code-switch.git
...
### 报告问题
发现 bug 或有功能建议？[提交 Issue](https://github.com/onchainyaotoshi/claude-code-switch/issues)。
...
- **新增 HCNSEC 提供商** - 添加幻城网安直连支持（`ccm hcnsec`、`ccm user hcnsec`、`ccm project hcnsec`）
  ...
  - 默认模型：`DeepSeek-V4-Pro`（请使用 HCNSEC 控制台中显示的精确大小写）
